...
function get_Biplot($file_pcoa_or_nmds,$path_output_biplot_otu,$path_biplot_txt,$path_output_biplot_Metadata,$path_input_file_metadata){
	 ...
	 $cmd = "/usr/bin/Rscript  R_Script/Scatter_biplot_graph_phylotype.R $file_pcoa_or_nmds $path_output_biplot_otu $path_biplot_txt $path_output_biplot_Metadata $path_input_file_metadata";
     exec($cmd);
