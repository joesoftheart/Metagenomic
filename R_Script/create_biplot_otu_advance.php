...
for($i=0; $i < sizeof($val_name_cal); $i++){
   ...
   $file_subsample = "owncloud/data/$user/files/$project/output/final.opti_mcc.".$level.".subsample.".$method_otu.".corr.axes_".$val_name_cal[$i];

   $file_taxonomy = "owncloud/data/$user/files/$project/output/final.opti_mcc.".$level.".cons.taxonomy";
