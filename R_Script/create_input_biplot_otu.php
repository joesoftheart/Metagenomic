...
$user = $argv[1];
$project = $argv[2];
$file_subsample = "../owncloud/data/$user/files/$project/output/final.opti_mcc.0.03.subsample.spearman.corr.axes";
$file_taxonomy = "../owncloud/data/$user/files/$project/output/final.opti_mcc.0.03.cons.taxonomy";
