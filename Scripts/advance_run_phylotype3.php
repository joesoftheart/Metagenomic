...
function plot_graph_r_NMD($user,$project,$path_in,$path_out){
    ...
    if($GLOBALS['check'] == "pcoa"){
        ...
        for($i=0;$i < sizeof($cal_replace);$i++){
            ...
            $path_input_axes_name  .= "owncloud/data/$user/files/$project/output/final.tx.".$cal_replace[$i].".".$GLOBALS['level'].".lt.ave.pcoa.axes"."-"."data_report_mothur/$user/$project/beta_diversity_analysis/PCoA_".$cal_replace[$i].".svg"." ";
        ...
        for($i=0;$i < sizeof($cal_replace);$i++){
            ...
            $path_input_axes_name .= "owncloud/data/$user/files/$project/output/final.tx.".$cal_replace[$i].".".$GLOBALS['level'].".lt.ave.nmds.axes"."-"."data_report_mothur/$user/$project/beta_diversity_analysis/NMD_".$cal_replace[$i].".svg"." ";
