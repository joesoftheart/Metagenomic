              ...
              <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                  <div class="panel-body">
                         ...
                         <center>
                           <div class="row">
                              ...
                              <div class="col-md-7">
                                  ...
                                  <img src="<?php echo base_url();?>data_report_mothurQiime/<?=$user?>/<?=$project?>/taxonomy_classification/bar_plot.png"  width="600px" height="850px">

                              </div> 
                            
                             <div class="col-md-5 col-md-pull-1">
                                  <img src="<?php echo base_url();?>data_report_mothurQiime/<?=$user?>/<?=$project?>/taxonomy_classification/bar_plot_legend.png" width="600px" height="150px">
                         ...
                         <p class="fa fa-bookmark"> &nbsp;&nbsp;Genus level </p> 
                          <br/>
                         <center>
                           <img src="<?php echo base_url();?>data_report_mothurQiime/<?=$user?>/<?=$project?>/taxonomy_classification/heatmap.png" width="550px" height="550px">
                         </center>
            ...
            <div class="panel panel-info">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                         <div class="panel-body">
                          ...
                          <br/>
                         <center>
                           <img src="<?php echo base_url();?>data_report_mothurQiime/<?=$user?>/<?=$project?>/alpha_diversity_analysis/boxplots_chao.png" width="550px" height="550px">
                         </center>
                         ...
                         <br/>
                         <center>
                           <img src="<?php echo base_url();?>data_report_mothurQiime/<?=$user?>/<?=$project?>/alpha_diversity_analysis/boxplots_shannon.png" width="550px" height="550px">
                         </center>
                        ...
                        <br/>
                         <p class="fa fa-bookmark"> &nbsp;&nbsp;Rarefaction curve </p> 
                          <br/>
                         <center>
                           <img src="<?php echo base_url();?>data_report_mothurQiime/<?=$user?>/<?=$project?>/alpha_diversity_analysis/Rarefactionqiime.png" width="550px" height="550px">
                         </center>
            ...
            <div class="panel panel-info">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse" aria-expanded="false">
                        <div class="panel-body">
                         ...
                         <iframe  width="100%" height="500px" src="<?php echo base_url();?>data_report_mothurQiime/<?=$user?>/<?=$project?>/beta_diversity_analysis/2d_plots_coordinate/unweighted_unifrac_pc_2D_PCoA_plots.html">
            ...
            <div class="panel panel-info">
                    ...
                    <div id="collapsefour" class="panel-collapse collapse" aria-expanded="false">
                        <div class="panel-body">
                          ...
                          <?php 
                            $png_stamp = "data_report_mothurQiime/$user/$project/optional_output/bar_plot_STAMP.png";
                            if(file_exists($png_stamp)){ ?>
                            
                              <p class="fa fa-bookmark"> Bar plot </p> 
                              <br/>
                              <center>
                                 <img src="<?php echo base_url()?>data_report_mothurQiime/<?=$user?>/<?=$project?>/optional_output/bar_plot_STAMP.png" width="650px" height="650px">
                              </center>
...
<script type="text/javascript"> 
  ...
  document.getElementById("zipall").onclick = function(){
        ...
        $.ajax({ 
          type:"post",
          datatype:"json",
          url:"<?php echo base_url('mothur_qiime_report/check_dirzip'); ?>",
          data:{current:"<?=$current_project?>"},
          success:function(data){
            var dir = JSON.parse(data); 
            if(dir == "TRUE"){
             location.href="<?php echo site_url();?>mothur_qiime_report/down_zip/<?=$current_project?>";           
           }else{
            alert("FALSE");
          }
