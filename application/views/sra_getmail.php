         ...
         <div class="col-lg-12">
            ...
            <!-- /.panel-heading -->
             ...
             <ul class="nav nav-pills">
                 <li class="active"><a href="#home-email" data-toggle="tab" aria-expanded="true">Semd email to Ncbi</a>
                 </li>
                 <li class=""><a href="#home-download" data-toggle="tab" aria-expanded="false">Download file submisstion</a>
                 </li>
            ...
            <div class="col-lg-8"> 
              ...
              <?php echo form_open('Run_sra/inGetMail/'.$id_project, array('id'=>'formGetMail'));?>
                 ...
                 <div class="form-group">
                      ...
                      <input class="form-control" name="email" placeholder="email user" onblur="chk_email()" id="emails" required>
