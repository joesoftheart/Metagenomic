            ...
            <div class="panel-body" id="pipeline">
                ...
                <div class="row">
                    <div class="col-lg-2">
                        <button class="btn  btn-warning" style="width:100%">
                            Quality Control
                            <?php if (in_array("quality-finish", $keywords_split_line)) { ?> <i class="fa fa-check"
                                                                                                aria-hidden="true"></i><?php } else if (in_array("quality", $keywords_split_line)) {
                                ?>
                    ...
                    <div class="col-lg-2">
                        <button class="btn  btn-warning" style="width:100%">
                            Align Sequence
                            <?php if (in_array("align-sequence-finish", $keywords_split_line)) { ?> <i
                    ...
                    <div class="col-lg-2">
                        <button class="btn btn-outline btn-warning" style="width:100%">
                            Pre-custer-sequence
                            <?php if (in_array("pre-cluster-chimera-finish", $keywords_split_line)) { ?> <i
                                    class="fa fa-check" aria-hidden="true"></i>
                    ...
                    <div class="col-lg-2">
                        <button class="btn btn-outline btn-warning" style="width:100%">
                            Classify Sequence
                            <?php if (in_array("classify-sequence-remove-finish", $keywords_split_line)) { ?> <i
                                    class="fa fa-check" aria-hidden="true"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <button class="btn btn-outline btn-warning" style="width:100%">
                            Plot graph
                            <?php if (in_array("plot-graph-finish", $keywords_split_line)) { ?> <i class="fa fa-check"
                                                                                                   aria-hidden="true"></i>
                    ...
                    <div class="col-lg-2">
                        <button class="btn btn-outline btn-warning" style="width:100%">
                            ...
                            <?php if (in_array("alpha-beta-diversity-finish", $keywords_split_line)) { ?> <i
                                    class="fa fa-check" aria-hidden="true"></i>
                    ...
                    <div class="col-lg-2 ">
                        <button class="btn btn-outline btn-warning" style="width:100%">
                            Classify OTU
                            <?php if (in_array("classify-otu-finish", $keywords_split_line)) { ?> <i class="fa fa-check"
                                                                                                     aria-hidden="true"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 ">
                        <button class="btn btn-outline btn-warning" style="width:100%">
                            Make biom
                            <?php if (in_array("make-biom-finish", $keywords_split_line)) { ?> <i class="fa fa-check"
                                                                                                  aria-hidden="true"></i>
                    ...
                    <div class="col-lg-2">
                        <button class="btn btn-outline btn-warning" style="width:100%">
                            Picrust
                            <?php if (in_array("picrust-finish", $keywords_split_line)) { ?> <i class="fa fa-check"
                                                                                                aria-hidden="true"></i>
