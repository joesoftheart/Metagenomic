...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            ...
            <h3 class="page-header">SRA Running</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <?php echo form_open_multipart('Run_sra/read_stability_tsv/' . $id_project, array('id' => 'myform')); ?>
        ...
        interval = setInterval(function () {
            ...
            if (time === 0) {
                $.ajax({
                    type: "post",
                    datatype: "json",
                    url: "<?php echo site_url('Run_sra/check_script1'); ?>",
                    data: {data: getData},
