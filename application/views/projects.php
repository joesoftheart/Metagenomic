            ...
            <div class="uk-child-width-1-6\@xl" uk-grid>
                <div>
                    <ul class="uk-tab-right" uk-switcher="animation: uk-animation-fade" uk-tab>
                        <li class="uk-active "><a class="uk-text-capitalize uk-text-bold" href="#">Standard Mode <i
                                        class="fa fa-question-circle-o" aria-hidden="true"
                                        title="“Standard Mode” was designed in such a way that will optimize and generate the meaningful information/result/output for most of the samples submitted. In many cases, however, data requires a fine adjustment to the pipeline parameter for meaningful output/result. Thus the “Advance Mode” could be more appreciated."
                                        uk-tooltip></i></a>

                        </li>

                        <li><a class="uk-text-capitalize uk-text-bold" href="1" onclick="advance_mode(this);">Advance
                                Mode <i class="fa fa-question-circle-o" aria-hidden="true"
                                        title="“Advance Mode”, is designed for the optimum use of the software.  Users can make changes to the pipeline parameter which in turns increase the flexibility of the software. This mode allows the pipeline to be adjusted so that it will be able to handle with different types of data. Hence, it will be more applicable to different type of experiments. Introductions and recommendations to steps including quality control, align sequences & clean alignment, pre-cluster sequences & chimera detection, classify sequences, remove bacterial sequences, OTU preparation, which are provided in the section below. "
                                        uk-tooltip></i></a></li>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion"
                                                               href="#collapseTwo">2.Align sequence & Clean alignment #2
                                                                <i class="fa fa-question-circle-o" aria-hidden="true"
                                                                   title="There are 3 options for the “Alignment Step” in total which are SILVA, Greengenes and RDP. The default was set to be SILVA due to the fact that this database has a better performance at doing alignment than other databases. (REFERENCE) "
                                                                   uk-tooltip></i></a>
                                                        </h4>
                                                    </div>
                                                                    ...
                                                                    <table border="0" class="uk-table uk-table-middle">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><input class="uk-input form-control"
                                                                                           type="text" name="max_homo"
                                                                                           value="8"
                                                                                           readonly="readonly"
                                                                                           placeholder="8"></td>
                                                                            </tr>
                                                                ...
                                                                <div class="col-lg-7">
                                                                    <div class="form-group">
                                                                        <select class="uk-select uk-margin"
                                                                                name="align_seq" readonly="readonly">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion"
                                                               href="#collapseThree">3.Pre-cluster sequence & Chimera
                                                                detection #3 <i class="fa fa-question-circle-o"
                                                                                aria-hidden="true" title="This step is performed to check for the strand similarities, in other words, to check for a possible error in some strands. The main objective of this step is to de-noise the sequences, thus providing a better resolution. To check for errors the recommended number of different bases between strand are <2. [Pre-Cluster Sequences]
In addition to that, it is possible that the (PCR-based) amplification steps in NGS-platform may cause some errors. This type of errors may cause certain mismatched cases between primer/dimer and their template strand. [Chimera Detection]"
                                                                                uk-tooltip></i></a>
                                                        </h4>
                                                    </div>
	...
	Greengenes database is the only database that provide information down to species level, while SILVA and RDP can provide only information at the level of genus. In contrast to Greengenes, RDP database was cleaner and SILVA was mostly use for alignment (SILVA > RDP, in terms of taxa). “Taxon Elimination” is designed to remove the unwanted data (i.e., helping to clean the result). The default was set to eliminate the taxon of chloroplast, mitochondria, eukaryote, and unknown. Optionally, users can eliminate other information, which include an option to remove archaea-unknown and archaea-unknown & bacteria-unknown"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea
                                                                                        class="uk-textarea form-control"
                                                                                        name="rm_taxon"
                                                                                        readonly="readonly">Chloroplast-Mitochondria-Eukaryota-unknown</textarea>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion"
                                                               href="#collapseFive">5.Alpha/Beta diversity analysis #5
                                                                <i class="fa fa-question-circle-o" aria-hidden="true"
...
Beta – Diversity:
	“Beta – Diversity” will analyze the community of bacteria between different groups. During this step choices to view diagrams for different statistical calculator can be made. A total 7 statistical analysis will be provided in a table, i.e. lennon, jclass, moristahorn, sorabund, thetan, thetayc and braycurtis.  "
                                                                   uk-tooltip></i></a>
                                                        </h4>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-7 col-lg-offset-3">
                                                                    **subsamples detect from files<br>
                                                                    subsamples <input class="uk-input uk-width-1-4"
                                                                                      value="5000" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-7 col-lg-offset-3">
                                                                    **The number of total reads/groups after the
                                                                    preprocess<br>
                                                                    **subsamples detect from files<br>
                                                                    subsamples <input class="uk-input uk-width-1-4"
                                                                                      value="5000" disabled>
                        ...
                        <!-- ADVANCE  -->
                        <li>
                            <link href="<?php echo base_url(); ?>tooltip/smart_wizard_theme_arrows.css"
                                  rel="stylesheet"/>
                                        ...
                                        <div class="Pre-test">
                                            <form name="Pre-form" method="post" action="#"
                                                            ...
                                                            <div class="panel-group" id="accordion">
                                                                ...
                                                                <div class="panel panel-info">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse"
                                                                               ...
                                                                               href="#collapse1">1. Quality Control
                                                                                <i class="fa fa-question-circle-o"
                                                                                   onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div1');"></i>
                                                                            </a>
                                                                        </h4>
                                                                    </div>
                                                                    <div id="collapse1" class="panel-collapse collapse">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <label class="col-lg-10"> Screen
                                                                                reads </label>
                                                                            <div class="col-lg-10">

                                                                                <table border="0"
                                                                                       class="uk-table uk-table-middle">
                                                                                    <tr>
                                                                                        <td>maximum ambiguous</td>
                                                                                        <td><input id="mbig"
                                                                                                   class="form-control"
                                                                                                   type="number"
                                                                                                   name="maximum_ambiguous"
                                                                                                   min="0"
                                                                                                   placeholder="maximum ambiguous"
                                                                                                   onblur="checkvalue()"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><input id="mhomo"
                                                                                                   class="form-control"
                                                                                                   type="number"
                                                                                                   name="maximum_homopolymer"
                                                                                                   min="0"
                                                                                                   placeholder="maximum homopolymer"
                                                                                                   onblur="checkvalue2()"
                                                                                                   onkeypress='return validateNumber(event)'>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>minimum reads length</td>
                                                                                        <td><input id="miniread"
                                                                                                   class="form-control"
                                                                                                   type="number"
                                                                                                   name="minimum_reads_length"
                                                                                                   min="0"
                                                                ...
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse"
                                                                               data-parent="#accordion"
                                                                               href="#collapse2"> 2. Align Sequences &
                                                                                Clean Alignment
                                                                                <i class="fa fa-question-circle-o"
                                                                                   onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div2');"></i>
                                                                            </a>
                                                                        </h4>
                                                                    </div>
                                                                    <div id="collapse2" class="panel-collapse collapse">
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <select class="uk-select" name="alignment"
                                                                                    id="type_alignment">
                                                                                <option value="silva" selected> Silva
                                                                                </option>
                                                                            ...
                                                                            <div id="row_option_silva">
                                                                                ...
                                                                                <img src="<?php echo site_url('images/img_silva'); ?>"
                                                                                     width="65%" height="55%">


                                                                                <div class="radio">
                                                                                    <label>
                                                                                        <input name="option_silva"
                                                                                               value="v_full"
                                                                                               type="radio"
                                                                                               class="radio_silva">
                                                                                        Silva (Default)
                                                                                ...
                                                                                <div class="radio">
                                                                                    <label>
                                                                                        <input name="option_silva"
                                                                                               ...
                                                                                               type="radio"
                                                                                               class="radio_silva">
                                                                                        V1–V3 region with primers 27F
                                                                                        and 534R
                                                                                        &nbsp;<i
                                                                                                class="fa fa-question-circle-o"
                                                                                                onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div16');">
                                                                                        </i>
                                                                                    </label>
                                                                                </div>
                                                                                <div class="radio">
                                                                                    <label>
                                                                                        <input name="option_silva"
                                                                                               ...
                                                                                               type="radio"
                                                                                               class="radio_silva">
                                                                                        V3 – V4 region with primers 341F
                                                                                        and 802R
                                                                                        &nbsp;<i
                                                                                                class="fa fa-question-circle-o"
                                                                                                onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div17');"></i>
                                                                                    </label>
                                                                                </div>
                                                                                <div class="radio">
                                                                                    <label>
                                                                                        <input name="option_silva"
                                                                                               value="v4" type="radio"
                                                                                               class="radio_silva">
                                                                                        V4 region with primers 515F and
                                                                                        806R
                                                                                        &nbsp;<i
                                                                                                class="fa fa-question-circle-o"
                                                                                                onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div18');">
                                                                                        </i>
                                                                                    </label>
                                                                                </div>
                                                                                <div class="radio">
                                                                                    <label>
                                                                                        <input name="option_silva"
                                                                                               ...
                                                                                               type="radio"
                                                                                               class="radio_silva">
                                                                                        V3-V5 region with primer 341F
                                                                                        and 909R
                                                                                        &nbsp;<i
                                                                                                class="fa fa-question-circle-o"
                                                                                                onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div19');">
                                                                                        </i>
                                                                                    </label>
                                                                                </div>
                                                                                <div class="radio">
                                                                                    <label>
                                                                                        <input name="option_silva"
                                                                                               ...
                                                                                               type="radio"
                                                                                               class="radio_silva">
                                                                                        V4-V5 region with primers 518F
                                                                                        and 926R
                                                                                        &nbsp;<i
                                                                                                class="fa fa-question-circle-o"
                                                                                                onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div20');">
                                                                                        </i>
                                                                                    </label>
                                                                                </div>
                                                                ...
                                                                <div class="panel panel-info">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse"
                                                                               data-parent="#accordion"
                                                                               href="#collapse3"> 3. Pre-Clusters
                                                                                Sequences & Chimera Detection
                                                                                <i class="fa fa-question-circle-o"
                                                                                   onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div3');"></i>
                                                                            </a>
                                                                        </h4>
                                                                    </div>
                                                                    <div id="collapse3" class="panel-collapse collapse">
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <select class="uk-select" name="diffs">
                                                                                ...
                                                                                <option value="2" selected>diffs = 2
                                                                                </option>
                                                                ...
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse"
                                                                               data-parent="#accordion"
                                                                               href="#collapse4"> 4. Classify Sequences
                                                                                <i class="fa fa-question-circle-o"
                                                                                   onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div4');"></i>
                                                                            </a>
                                                                        </h4>
                                                                    </div>
                                                                    <div id="collapse4" class="panel-collapse collapse">
                                                                        <div class="panel-body">
                                                                            <label>Prepare the taxonomy
                                                                            ...
                                                                            <div class="col-lg-2"><label>(>=50)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="panel panel-info">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse"
                                                                               data-parent="#accordion"
                                                                               href="#collapse5"> 5. Remove Bacterial
                                                                                Sequences
                                                                                <i class="fa fa-question-circle-o"
                                                                                   onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div5');"></i>
                                                                            </a>
                                                                        </h4>
                                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input id="sub-test" class="btn btn-primary"
                                                        ...
                                                        <div class="panel-group" id="accordion">
                                                            ...
                                                            <div class="panel panel-info">
                                                                <div class="panel-heading">
                                                                    <h4 class="panel-title">
                                                                        <a data-toggle="collapse"
                                                                           data-parent="#accordion" href="#collapse13">1.
                                                                            Show data in count group
                                                                ...
                                                                <div id="collapse13" class="panel-collapse collapse">
                                                                    <div class="panel-body">
                                                                        ...
                                                                        <label>The number of total reads/group after the
                                                                            preprocess</label>
                                                                        <p class="col-lg-10"> show data in count
                                                                            group </p>
                                                                ...
                                                                <div id="collapse14" class="panel-collapse collapse">
                                                                    <div class="panel-body">
                                                                        ...
                                                                        <form name="Phylotype-form" method="post">
                                                                            ...
                                                                            <input type="hidden" id="max_num_subsample"
                                                                                   name="max_subsample">

                                                                            <label>Please put the number to subsampled
                                                                                file </label>
                                                                            <div class="row uk-margin">
                                        ...
                                        <div class="Pre-test3">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-11">
                                                    ...
                                                    <!-- Analysis-form -->
                                                    <form name="Analysis-form" method="post"
                                                          enctype="multipart/form-data">
                                                        <input type="hidden" name="username" value="<?= $username ?>">
                                                        <input type="hidden" name="project"
                                                               value="<?= $current_project ?>">
                                                                ...
                                                                <div class="panel panel-info">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse"
                                                                               data-parent="#accordion"
                                                                               href="#collapse12">1. Taxonomy Level
                                                                                <i class="fa fa-question-circle-o"
                                                                                   onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div8');"></i>
                                                                    ...
                                                                    <div id="collapse12"
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <label>Please select level that you want to
                                                                                analyse </label>
                                                                            ...
                                                                            <div class="Greengene">
                                                                                ...
                                                                                <div class="col-lg-6 col-lg-pull-4">
                                                                                    <select class="uk-select"
                                                                                            id="g_level">
                                                                                        <option value="1"> species
                                                                                        </option>
                                                                                        <option value="2" selected>
                                                                                            genus
                                                                                        </option>
                                                                                        <option value="3"> family
                                                                                        </option>
                                                                                        <option value="4"> order
                                                                                        </option>
                                                                                        <option value="5"> class
                                                                                        </option>
                                                                                        <option value="6"> phylum
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="Silva_RDP" style="display:none">
                                                                                <label class="col-lg-6"> Silva/RDP
                                                                                    : </label>
                                                                                <div class="col-lg-6 col-lg-pull-3">
                                                                                    <select class="uk-select"
                                                                                            id="sr_level">
                                                                                        <option value="1"> genus
                                                                                        </option>
                                                                                        <option value="2"> family
                                                                                        </option>
                                                                                        <option value="3"> order
                                                                                        </option>
                                                                                        <option value="4"> class
                                                                                        </option>
                                                                                        <option value="5"> phylum
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse"
                                                                               data-parent="#accordion"
                                                                               href="#collapse6">2. Alpha – Diversity
                                                                                <i class="fa fa-question-circle-o"
                                                                                   onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div6');"></i>
                                                                    ...
                                                                    <div id="collapse6" class="panel-collapse collapse">
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <label> Summary alpha statistical
                                                                                analysis </label>
                                                                            <div class="radio">
                                                                                <label> <input name="optionsRadios"
                                                                                               value="1" type="radio">
                                                                                    set the size of your smallest group
                                                                                    :
                                                                                    <input class="uk-input" id="alpha"
                                                                                           name="size_alpha"
                                                                                           type="number" min="0"
                                                                                           onkeypress='return validateNumber(event)'>
                                                                                </label>
                                                                            ...
                                                                            <div class="radio">
                                                                                <label> <input name="optionsRadios"
                                                                                               id="myradio" type="radio"
                                                                                               checked> No need set the
                                                                                    size </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="panel panel-info">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse"
                                                                               data-parent="#accordion"
                                                                               href="#collapse7">3. Beta – Diversity
                                                                                <i class="fa fa-question-circle-o"
                                                                                   onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div7');"></i>
                                                                    ...
                                                                    <div id="collapse7" class="panel-collapse collapse">
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <label> Summary beta statistical
                                                                                analysis </label>
                                                                            <div class="radio">
                                                                                <label> <input name="optionsRadios1"
                                                                                               value="1" type="radio">
                                                                                    set the size of your smallest group
                                                                                    :
                                                                                    <input class="uk-input" id="beta"
                                                                                           name="size_beta"
                                                                                           type="number" min="0"
                                                                                           onkeypress='return validateNumber(event)'>
                                                                                </label>
                                                                ...
                                                                <div class="panel panel-default">
                                                                    ...
                                                                    <div id="collapse8" class="panel-collapse collapse">
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <label class="col-lg-11"> Venn
                                                                                Diagram</label>
                                                                            <p class="col-lg-11">Please put the sample
                                                                                name</p>
                                                                            <label class="col-lg-3 "><select
                                                                                        class="uk-select" name="venn1"
                                                                                        id="venn1"></select></label>
                                                                            <label class="col-lg-3 "><select
                                                                                        class="uk-select" name="venn2"
                                                                                        id="venn2"></select></label>
                                                                            <label class="col-lg-3 "><select
                                                                                        class="uk-select" name="venn3"
                                                                                        id="venn3"></select></label>
                                                                            <label class="col-lg-3"><select
                                                                                        class="uk-select" name="venn4"
                                                                                        id="venn4"></select> </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="panel panel-info">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse"
                                                                               data-parent="#accordion"
                                                                               href="#collapse9">5. UPGMA tree with
                                                                                calculator
                                                                                <i class="fa fa-question-circle-o"></i>
                                                                    ...
                                                                    <div id="collapse9" class="panel-collapse collapse">
                                                                        <div class="panel-body">
                                                                            <div class="col-lg-10">
                                                                                <label class="col-lg-7"> Community
                                                                                    structure </label>
                                                                                <div class="col-lg-7 col-lg-push-1 ">
                                                                                    <input type='checkbox'
                                                                                           name='upgma_st[]'
                                                                                           value='braycurtis'>braycurtis
                                                                                    <br/>
                                                                                    <input type='checkbox'
                                                                                           name='upgma_st[]'
                                                                                           value='thetan'>thetan <br/>
                                                                                    <input type='checkbox'
                                                                                           name='upgma_st[]'
                                                                                           value='thetayc'>thetayc <br/>
                                                                                    <input type='checkbox'
                                                                                           name='upgma_st[]'
                                                                                           value='morisitahorn'>
                                                                                    morisitahorn <br/>
                                                                ...
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse"
                                                                               data-parent="#accordion"
                                                                               href="#collapse10">6. Ordination Method
                                                                                <i class="fa fa-question-circle-o"></i>
                                                                    ...
                                                                    <div id="collapse10"
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <label class="col-lg-10"> PCoA : <input
                                                                                        name="func" type="radio"
                                                                                        id="radio_pcoa"> Use
                                                                                PCoA</label>
                                                                            <div class="col-lg-7 col-lg-push-2 ">
                                                                                ...
                                                                                <div class="col-lg-7 col-lg-push-1 ">
                                                                                    ...
                                                                                    <input type='checkbox'
                                                                                           name='pcoa_st[]'
                                                                                           value='thetan' class="pcoa"
                                                                                           disabled> thetan <br/>
                                                                                    <input type='checkbox'
                                                                                           name='pcoa_st[]'
                                                                                           value='thetayc' class="pcoa"
                                                                                           disabled> thetayc <br/>
                                                                                    <input type='checkbox'
                                                                                           name='pcoa_st[]'
                                                                                           value='morisitahorn'
                                                                            ...
                                                                            <div class="col-lg-7 col-lg-push-2 ">
                                                                                ...
                                                                                <div class="col-lg-7 col-lg-push-1 ">
                                                                                    <input type='checkbox'
                                                                                           name='pcoa_me[]'
                                                                                           value='jclass' class="pcoa"
                                                                                           disabled> jclass <br/>
                                                                                    <input type='checkbox'
                                                                                           name='pcoa_me[]'
                                                                                           value='lennon ' class="pcoa"
                                                                                           disabled> lennon
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-12 uk-margin"></div>
                                                                            <label class="col-lg-10 "> NMDS : <input
                                                                                        name="func" type="radio"
                                                                                        id="radio_nmds"> Use
                                                                                NMDS</label>
                                                                            ...
                                                                            <div class="col-lg-9 col-lg-push-2 ">
                                                                                ...
                                                                                <div class="col-lg-9 col-lg-push-1 ">
                                                                                    ...
                                                                                    <input type='checkbox'
                                                                                           name='nmds_st[]'
                                                                                           value='thetan' class="nmds"
                                                                                           disabled> thetan <br/>
                                                                                    <input type='checkbox'
                                                                                           name='nmds_st[]'
                                                                                           value='thetayc' class="nmds"
                                                                                           disabled> thetayc <br/>
                                                                                    <input type='checkbox'
                                                                                           name='nmds_st[]'
                                                                                           value='morisitahorn'
                                                                            ...
                                                                            <div class="col-lg-9 col-lg-push-2 ">
                                                                                ...
                                                                                <div class="col-lg-9 col-lg-push-1 ">
                                                                                    <input type='checkbox'
                                                                                           name='nmds_me[]'
                                                                                           value='jclass' class="nmds"
                                                                                           disabled> jclass <br/>
                                                                                    <input type='checkbox'
                                                                                           name='nmds_me[]'
                                                                                           value='lennon' class="nmds"
                                                                                           disabled> lennon
                                                                ...
                                                                <div class="panel panel-info">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse"
                                                                               data-parent="#accordion"
                                                                               href="#collapse11">7. Optional
                                                                                <i class="fa fa-question-circle-o"
                                                                                   onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div12');"></i>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="col-lg-8 ">
                                                                                <label> Create file design
                                                                                    <i class="fa fa-question-circle-o"
                                                                                       onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div11');">
                                                                                    </i>
                                                                                    <a href="<?php echo site_url(); ?>createdesign/<?= $current_project ?>"
                                                                                       target="_blank"><input
                                                                                                type="button"
                                                                                ...
                                                                                <div>
                                                                                    <p id="pass_design"
                                                                                       class="fa fa-file-text-o"> No
                                                                                        file design </p>
                                                                                    <input type="hidden" id="p_design"
                                                                                           name="f_design"
                                                                                           value="nodesign">
                                                                            ...
                                                                            <div class="col-lg-8 col-lg-push-1 ">
                                                                                <div class="radio">
                                                                                    ...
                                                                                    <i class="fa fa-question-circle-o"
                                                                                       onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div9');"></i>
                                                                                </div>
                                                                                <div class="radio">
                                                                                    <label> <input name="optionsRadios2"
                                                                                                   value="homova"
                                                                                    ...
                                                                                    <i class="fa fa-question-circle-o"
                                                                                       onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div10');"></i>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-10 uk-margin">
                                                                                ...
                                                                                <label> Create file metadata
                                                                                    <i class="fa fa-question-circle-o"
                                                                                       onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div13');">
                                                                                    </i>
                                                                                    <a href="<?php echo base_url(); ?>createmetadata/<?= $current_project ?>"
                                                                                       target="_blank"><input
                                                                                                type="button"
                                                                                                class="btn btn-outline btn-info"
                                                                                                value="create metadata"
                                                                                                id="check_metadata">
                                                                                    </a>
                                                                                </label>
                                                                                <div>
                                                                                    <p id="pass_metadata"
                                                                                       class="fa fa-file-text-o"> No
                                                                                        file metadata </p>
                                                                                    <input type="hidden" id="p_metadata"
                                                                                           name="f_metadata"
                                                                                           value="nometadata">
                                                                            ...
                                                                            <label class="col-lg-6">
                                                                                <input type="checkbox"
                                                                                       id="correlation_meta"
                                                                                       value="meta"> correlation with
                                                                                metadata
                                                                                <i class="fa fa-question-circle-o"
                                                                                   onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div14');">
                                                                                </i>
                                                                            ...
                                                                            <div class="col-lg-4 col-lg-pull-2">
                                                                                <select class="uk-select"
                                                                                        name="method_meta">
                                                                                    <option value="spearman"> spearman
                                                                                    </option>
                                                                                    <option value="pearson"> pearson
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            ...
                                                                            <label class="col-lg-6">
                                                                                <input type="checkbox"
                                                                                       id="correlation_otu" value="otu">
                                                                                correlation of each OTU
                                                                                <i class="fa fa-question-circle-o"
                                                                                   onmouseover="tooltip.ajax(this, '<?php echo base_url(); ?>tooltip/tooltip-ajax.html#div15');">
                                                                                </i>
                                                        ...
                                                        <div class="col-lg-12 uk-margin"></div>
                                                        <div class="col-lg-4 col-lg-push-2">
                                                            <input id="sub-test3" class="btn btn-primary"
                                                                   value="Run Preprocess">
                                                        </div>
                                                        <div class="col-lg-12 uk-margin"></div>
