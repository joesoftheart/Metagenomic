         ...
         <div class="panel-group" id="accordion">
             ...
             <div class="panel-heading">          
                <h4 class="panel-title">
                 <a  data-toggle="collapse" data-parent="#accordion" href="#collapse1" >1. Create a project file + 
                 </a>
                 </h4>
             </div>
             <div id="collapse1" class="panel-collapse collapse">
             <div class="panel-body">       
              <p> Please fill the infomation of you project (Unknown or inapplicable fields can be filled in with 'missing')</p>                 
            ...
            <div class="col-lg-6">
               <div class="form-group">
                 <label>Email:</label>
                 <input class="form-control" id="emails" name="email" type="email" onblur="chk_email()" required> 
            ...
            <div class="col-lg-4">
             ...
             <div id="collapse2" class="panel-collapse collapse">
                 ...
                 <div class="col-lg-12 col-lg-push-1" id="default_data" style="display:none">
                    <input name="optionsRadios"value="miscellaneous" type="radio" required> miscellaneous      
                 </div>

                 <label class="col-lg-12 ">
                 <i class="fa fa-plus-circle" id="environment_show"> Environment</i> 
                 <i class="fa fa-minus-circle" id="environment_hide" style="display:none"> Environment</i>
                 </label>
                 <div class="col-lg-12 col-lg-push-1" id="environment_data" style="display:none">                    
                    ...
                    <br/>
                    <input name="optionsRadios" value="host_associated" type="radio" required> host_associated<br/>
                    <input name="optionsRadios" value="soil" type="radio" required> soil<br/>
                    <input name="optionsRadios" value="wastewater" type="radio" required> wastewater<br/>
                 ...
                 <div class="col-lg-12 col-lg-push-1" id="plant_data" style="display:none">
                     <input name="optionsRadios" value="plant_associated" type="radio" required> plant_associated
                 ...
                 <div class="col-lg-12 col-lg-push-1"  id="human_data"style="display:none">
                      <input name="optionsRadios" value="human_associated" type="radio" required> human_associated <br/>
                      <input name="optionsRadios" value="human_gut" type="radio" required> human_gut <br/>
                      <input name="optionsRadios" value="human_oral" type="radio" required> human_oral <br/>
                      <input name="optionsRadios" value="human_skin" type="radio" required> human_skin <br/>
                      <input name="optionsRadios" value="human_vaginal" type="radio" required> human_vaginal <br/>
                 </div>
